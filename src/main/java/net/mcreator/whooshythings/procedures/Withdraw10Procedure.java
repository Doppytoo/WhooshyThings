...
public class Withdraw10Procedure extends WhooshyThingsModElements.ModElement {
	public Withdraw10Procedure(WhooshyThingsModElements instance) {
		super(instance, 5);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure Withdraw10!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		if ((((entity.getCapability(WhooshyThingsModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new WhooshyThingsModVariables.PlayerVariables())).Balance) >= 1)) {
