...
public class Deposit100Procedure extends WhooshyThingsModElements.ModElement {
	public Deposit100Procedure(WhooshyThingsModElements instance) {
		super(instance, 7);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure Deposit100!");
			return;
		}
