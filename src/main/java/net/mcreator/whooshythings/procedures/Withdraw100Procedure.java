...
public class Withdraw100Procedure extends WhooshyThingsModElements.ModElement {
	public Withdraw100Procedure(WhooshyThingsModElements instance) {
		super(instance, 8);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure Withdraw100!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		if ((((entity.getCapability(WhooshyThingsModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new WhooshyThingsModVariables.PlayerVariables())).Balance) >= 16)) {
