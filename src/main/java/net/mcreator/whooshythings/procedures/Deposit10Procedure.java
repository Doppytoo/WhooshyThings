...
public class Deposit10Procedure extends WhooshyThingsModElements.ModElement {
	public Deposit10Procedure(WhooshyThingsModElements instance) {
		super(instance, 4);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure Deposit10!");
			return;
		}
